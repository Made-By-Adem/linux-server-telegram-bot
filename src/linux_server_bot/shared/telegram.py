...
def send_loading(bot: telebot.TeleBot, chat_id: int, label: str) -> telebot.types.Message:
    """Send a loading indicator. Returns the message so it can be edited with the result."""
    return bot.send_message(chat_id, f"\U0001f504 {label}...")
